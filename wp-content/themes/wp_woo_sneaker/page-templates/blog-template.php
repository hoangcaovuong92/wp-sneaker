...
get_header(); ?>
	...
	?>
		<div class="slideshow-wrapper main-slideshow <?php wd_page_layout_class('main_slider_layout');//echo strcmp($page_datas['page_layout'],'wide') == 0 ? "wide" : "container"; ?>">
		...
		<?php if( !is_home() && !is_front_page() ):
			if( isset($page_datas['hide_breadcrumb']) && absint($page_datas['hide_breadcrumb']) == 0 ): 
				wd_show_breadcrumbs();
			endif; 
		endif;?>	
