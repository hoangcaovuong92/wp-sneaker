...
if ( $products->have_posts() ) : ?>
	...
	<div class="cross-sells">
		...
		<div class="wd-cross-sells-title"><h2 class="heading-title"><?php _e( 'You may also like', 'wpdance' ) ?></h2></div>
...
<script type="text/javascript">
	jQuery(document).ready(function(){
		jQuery(".woocommerce .cross-sells ul.products li").removeClass("span24 span12 span8 span6 span4").addClass("span6");
	});
</script>
<?php endif;
