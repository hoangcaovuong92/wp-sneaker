		...
		<div class="wd_tini_cart_wrapper">
			<div class="wd_tini_cart_control ">
				...
				<span class="cart_size">
					...
					<!--<span class="cart_subtotal"><?php //echo WC()->cart->get_cart_subtotal(); ?></span>-->
			...
			<div class="cart_dropdown drop_down_container">
				...
				<div class="dropdown_header">
					<h4><a href="<?php echo esc_url( wc_get_cart_url() );?>"><?php _e('shopping bag','wpdance');?></a></h4>
								...
								<li class="<?php echo $_cart_li_class = ($_index == 0 ? "first" : ($_index == count($_cart_array) - 1 ? "last" : "")) ?>">
									...
									<div class="cart_item_wrapper">	
										...
										<a href="<?php echo get_permalink( $cart_item['product_id'] ); ?>">
											...
											<?php
												echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf('<a href="%s" class="remove" title="%s">&times;</a>', wc_get_cart_remove_url($cart_item_key), __( 'Remove this item', 'wpdance' ) ), $cart_item_key );
										?>
									</div>
								</li>
				...
				<div class="dropdown_footer">
					<?php if ( !$_cart_empty ) : ?>
						...
						<p class="total"><span class="title"><?php _e( 'Total :', 'wpdance' ); ?></span> <?php echo WC()->cart->get_cart_subtotal(); ?></p>
						...
						<span class="go_to_shopping_cart">
							<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" ><?php _e("View cart","wpdance"); ?></a>
						</span>
