...
<div class="shortcode-config">
	...
	<span id="carousel-shortcode" name="carousel-shortcode">
		<select name="portfolio_slider_config_size">
			...
			<option value="prod_midium_thumb" <?php if( strcmp(esc_html($portfolio_slider_config['portfolio_slider_config_size']),'prod_midium_thumb') == 0 ) echo "selected";?>>Slider 3( 366x360 )</option>
			<option value="prod_small_thumb" <?php if( strcmp(esc_html($portfolio_slider_config['portfolio_slider_config_size']),'prod_small_thumb') == 0 ) echo "selected";?>>Slider 4( 141x141 )</option>
