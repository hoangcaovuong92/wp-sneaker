...
class WP_Widget_Wd_Layered_Nav extends WP_Widget {
	...
	function __construct() {
    	$widget_setting = array(
			'name' 		=> esc_html__('WD - Layered Nav','wpdance'),
			'desc' 		=> esc_html__('Shows a custom attribute in a widget which lets you narrow down the list of products when viewing product categories.','wpdance'),
			'slug' 	  	=> 'wd_layered_nav',
			'class' 	=> 'wd widget_layered_nav',
		);
