...
get_header(); 
?>
		<div class="slideshow-wrapper main-slideshow <?php wd_page_layout_class('main_slider_layout'); ?>">
		...
		<div id="container" class="page-template default-template <?php wd_page_layout_class('main_content_layout'); ?>">
