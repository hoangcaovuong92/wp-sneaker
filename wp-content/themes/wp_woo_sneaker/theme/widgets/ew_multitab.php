	...
	class WP_Widget_Ew_multitab extends WP_Widget {
		function __construct() {
	    	$widget_setting = array(
				'name' 		=> esc_html__('WD - MultiTab','wpdance'),
				'desc' 		=> esc_html__('WD - MultiTab','wpdance'),
				'slug' 	  	=> 'multitab',
			...
			<div id="tabs-post-sidebar" class="tabs-post-sidebar">
				...
				<div class="tab-content">
					...
					<div class='top-left'><div class='top-right'></div></div>
						...
						<?php } else { ?>
							<span class="no-information"><?php _e( 'No information','wpdance' ); ?></span>
						<?php } ?>
						<?php wp_reset_query(); ?>
			...
			<div class="accordion-tabs wd-widget-multitabs-accordion" id="<?php echo $random_id;?>" style="display:none;">
				...
				<div class="accordion-group">
					<div class="accordion-heading">
						<a class="accordion-toggle collapsed" href="#collapseOne-<?php echo $rand_id;?>" data-parent="#<?php echo $random_id;?>" data-toggle="collapse"><span><span><?php echo esc_attr($title_recent); ?></span></span></a>
					</div>
				...
				<div class="accordion-group">
					<div class="accordion-heading">
						<a class="accordion-toggle collapsed" href="#collapseTwo-<?php echo $rand_id;?>" data-parent="#<?php echo $random_id;?>" data-toggle="collapse"><span><span><?php echo esc_attr($title_comment); ?></span></span></a>
					</div>
