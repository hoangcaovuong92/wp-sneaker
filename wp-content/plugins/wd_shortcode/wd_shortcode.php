...
class WD_Shortcode
{
	...
	protected function initArrShortcodes(){
		...
		,'bt_badges','bt_multitab','bt_tooltips','bt_alerts','bt_progress_bars','bt_carousel','menu','wd_features','wd_testimonial','woo-shortcode');
	}
	...
	public function init_script(){
		...
		wp_enqueue_style( 'sneaker-roboto', "$protocol://fonts.googleapis.com/css?family=Roboto" );
