...
<div class="shortcode-config">
	...
	<span id="carousel-shortcode" name="carousel-shortcode">
		<select name="portfolio_slider_config_size">
			<option value="slider" <?php if( strcmp(esc_html($portfolio_slider_config['portfolio_slider_config_size']),'slider') == 0 ) echo "selected";?>>Slider 1( 160x70 )</option>
			<option value="blog_thumb" <?php if( strcmp(esc_html($portfolio_slider_config['portfolio_slider_config_size']),'blog_thumb') == 0 ) echo "selected";?>>Slider 2( 425x425 )</option>
			<option value="prod_medium_thumb" <?php if( strcmp(esc_html($portfolio_slider_config['portfolio_slider_config_size']),'prod_medium_thumb') == 0 ) echo "selected";?>>Slider 3( 400x400 )</option>
			<option value="related_thumb" <?php if( strcmp(esc_html($portfolio_slider_config['portfolio_slider_config_size']),'related_thumb') == 0 ) echo "selected";?>>Slider 4( 213x213 )</option>			
