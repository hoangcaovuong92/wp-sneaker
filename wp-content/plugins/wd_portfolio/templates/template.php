...
?>
						<div id="portfolio-container" class="<?php echo esc_attr($style); ?>">
							...
							<div class="end_content">
							   <div class="count_project"><span class="number_project"><?php echo wp_count_posts('portfolio')->publish; ?></span><?php if(wp_count_posts('portfolio')->publish > 1) { _e(' Projects','wpdance'); } else { _e(" Project","wpdance"); } ?></div>
							   <?php
									$display_pagenavi = ((wp_count_posts('portfolio')->publish <= $post_per_page) || $post_per_page <= 0)?"style='display: none'":"";
							   ?>
							   <div class="page_navi" <?php echo $display_pagenavi; ?>><div class="nav-content"><?php ew_pagination(); wp_reset_query();?></div></div>
							</div>
							<?php endif; ?>
						</div>
